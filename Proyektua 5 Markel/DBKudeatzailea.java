...
public class DBKudeatzailea {
    ...
    // Funtzio BERRIA: Biltegi jakin batean erreferentzia batek duen stock-a itzultzen du
    ...
    // ALDATUTA: Orain biltegi zehatz bat jasotzen du eta bakarrik stock-a ezabatuko du bertatik
    ...
    // ALDATUTA: Orain String (erreferentzia) jasotzen du ID-aren ordez
    public void donazioaErregistratuDB(String erref, String nan, java.sql.Date data, int kantitatea) {
        ...
        try (CallableStatement stmt = konexioa.prepareCall(call)) {
            ...
            // SQL errorea bada (produkturik ez badago) mezu garbia emateko
